...
<div class="mb-8">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold bg-gradient-to-r from-village-primary to-village-secondary bg-clip-text text-transparent">
                Dashboard Admin
            </h1>
            <p class="text-gray-600 mt-2">Selamat datang di panel administrasi SIDESA Cibeureum</p>
        </div>
        <div class="flex items-center space-x-3">
            ...
            <div class="w-12 h-12 bg-gradient-to-br from-village-primary to-village-secondary rounded-xl flex items-center justify-center shadow-lg animate-float">
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    <a href="{{ route('admin.pengajuan.list') }}" class="stat-card-hover group">
        <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:border-village-primary/30 transition-all duration-300">
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-2xl font-bold text-gray-900 group-hover:text-village-primary transition-colors">
                        {{ $pengajuanPending }}
                    </div>
                    <div class="text-sm text-gray-600 font-medium">Perlu Diproses</div>
    ...
    <a href="{{ route('admin.agenda.create') }}" class="stat-card-hover group">
        <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:border-village-primary/30 transition-all duration-300">
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-sm text-gray-600 font-medium">Tambah Agenda</div>
                    <div class="text-xs text-gray-400 mt-1">Buat agenda baru</div>
                </div>
                <div class="w-12 h-12 bg-gradient-to-br from-village-primary to-village-secondary rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                    <i class="fas fa-plus text-white"></i>
                </div>
            </div>
            <div class="mt-4 flex items-center text-xs text-village-primary">
    ...
    <a href="{{ route('admin.data-kependudukan.index') }}" class="stat-card-hover group">
        <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:border-village-primary/30 transition-all duration-300">
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-sm text-gray-600 font-medium">Data Penduduk</div>
    ...
    <button onclick="generateReport()" class="stat-card-hover group text-left">
        <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:border-village-primary/30 transition-all duration-300">
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-sm text-gray-600 font-medium">Generate Laporan</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="stat-card-hover">
        <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-2xl font-bold text-gray-900">{{ number_format($totalPengguna) }}</div>
    ...
    <div class="stat-card-hover">
        <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-2xl font-bold text-gray-900">{{ number_format($totalPengajuan) }}</div>
                    <div class="text-sm text-gray-600 font-medium">Total Pengajuan</div>
                </div>
    ...
    <div class="stat-card-hover">
        <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-2xl font-bold text-gray-900">{{ number_format($pengajuanDisetujui) }}</div>
            ...
            <div class="mt-4 flex items-center">
                <div class="flex items-center text-xs text-emerald-600">
                    ...
                    <span>{{ number_format(($pengajuanDisetujui / max($totalPengajuan, 1)) * 100, 1) }}% rasio persetujuan</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="stat-card-hover">
        <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-2xl font-bold text-gray-900">{{ number_format($agendaAktif) }}</div>
                    <div class="text-sm text-gray-600 font-medium">Agenda Aktif</div>
                </div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
    ...
    <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h3 class="text-lg font-semibold text-gray-900">Pengajuan Bulanan</h3>
                <p class="text-sm text-gray-500">Trend pengajuan 6 bulan terakhir</p>
            </div>
            <div class="w-10 h-10 bg-gradient-to-br from-village-primary to-village-secondary rounded-lg flex items-center justify-center shadow-lg">
    ...
    <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
        <div class="flex items-center justify-between mb-6">
            <div>
                ...
                <p class="text-sm text-gray-500">Breakdown pengajuan berdasarkan status</p>
            </div>
            <div class="w-10 h-10 bg-gradient-to-br from-village-primary to-village-secondary rounded-lg flex items-center justify-center shadow-lg">
    ...
    <div class="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-village-primary/5 to-village-secondary/5">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500">Daftar pengajuan yang perlu ditindaklanjuti</p>
            </div>
            <a href="{{ route('admin.pengajuan.list') }}" class="inline-flex items-center px-4 py-2 bg-village-primary text-white rounded-lg hover:bg-village-secondary transition-colors text-sm font-medium">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="w-8 h-8 bg-gradient-to-br from-village-primary to-village-secondary rounded-full flex items-center justify-center shadow-lg mr-3">
                                    <i class="fas fa-user text-white text-xs"></i>
                                </div>
                                <div>
                                    <div class="text-sm font-medium text-gray-900">{{ $pengajuan->user->name ?? 'User tidak ditemukan' }}</div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm text-gray-900">{{ $pengajuan->jenisSurat->nama ?? 'Jenis surat tidak ditemukan' }}</span>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-8 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="text-gray-500">Tidak ada pengajuan surat yang ditemukan</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
