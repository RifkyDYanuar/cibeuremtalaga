                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="judul" name="judul" 
                                       value="{{ old('judul', $agenda->judul) }}" placeholder="Masukkan judul agenda..." required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="deskripsi" name="deskripsi" rows="6" 
                                          placeholder="Jelaskan detail agenda kegiatan..." required>{{ old('deskripsi', $agenda->deskripsi) }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="lokasi" name="lokasi" 
                                       value="{{ old('lokasi', $agenda->lokasi) }}" placeholder="Contoh: Balai Desa Cibeureum" required>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" class="form-control" id="tanggal_mulai" 
                                           name="tanggal_mulai" value="{{ old('tanggal_mulai', $agenda->tanggal_mulai->format('Y-m-d\TH:i')) }}" required>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" class="form-control" id="tanggal_selesai" 
                                           name="tanggal_selesai" value="{{ old('tanggal_selesai', $agenda->tanggal_selesai->format('Y-m-d\TH:i')) }}" required>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="kategori" name="kategori" required>
                                    ...
                                    <option value="kegiatan" {{ old('kategori', $agenda->kategori) == 'kegiatan' ? 'selected' : '' }}>Kegiatan</option>
                                    <option value="musyawarah" {{ old('kategori', $agenda->kategori) == 'musyawarah' ? 'selected' : '' }}>Musyawarah</option>
                            ...
                            @if($agenda->gambar)
                                <div class="form-group">
                                    ...
                                    <div class="current-image">
                                        <img src="{{ Storage::url($agenda->gambar) }}" alt="Current image" class="current-img">
                                    </div>
                                </div>
                            @endif
                            <div class="form-group">
                                <label for="gambar" class="form-label">
                                    {{ $agenda->gambar ? 'Ganti Gambar' : 'Upload Gambar' }}
                                </label>
