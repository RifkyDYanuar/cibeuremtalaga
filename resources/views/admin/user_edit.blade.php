        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <nav class="flex items-center space-x-2 text-sm text-gray-600 mt-2">
                    ...
                    <i class="fas fa-chevron-right text-gray-400"></i>
                    <a href="{{ route('admin.users.show', $user->id) }}" class="hover:text-emerald-600 transition-colors duration-200">{{ $user->name }}</a>
                    <i class="fas fa-chevron-right text-gray-400"></i>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 overflow-hidden">
                ...
                <div class="p-8">
                    <form action="{{ route('admin.users.update', $user->id) }}" method="POST" id="editUserForm" class="space-y-6">
                        @csrf
                        @method('PUT')
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        <div class="bg-gray-50 rounded-lg p-4 border-l-4 border-emerald-500">
                            <div class="flex items-center gap-2 text-sm font-medium text-gray-600 mb-1">
                                <i class="fas fa-id-card text-emerald-500"></i>
                                User ID
                            </div>
                            <div class="text-gray-900 font-semibold">{{ $user->id }}</div>
                        </div>
                        ...
                        <div class="bg-gray-50 rounded-lg p-4 border-l-4 border-blue-500">
                            ...
                            <div class="text-gray-900 font-semibold">{{ $user->created_at->format('d M Y, H:i') }}</div>
                        </div>
                        ...
                        <div class="bg-gray-50 rounded-lg p-4 border-l-4 border-orange-500">
                            ...
                            <div class="text-gray-900 font-semibold">{{ $user->updated_at->format('d M Y, H:i') }}</div>
                        </div>
                        ...
                        <div class="bg-gray-50 rounded-lg p-4 border-l-4 border-purple-500">
                            ...
                            <div class="text-gray-900 font-semibold">{{ $user->pengajuans->count() }}</div>
                        </div>
                    </div>
                </div>
            </div>
